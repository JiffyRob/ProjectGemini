...
class Script(SNEKProgram):
    def __init__(self, game, script, api=None):
        ...
        api = {
            ...
            "spawn": Spawn(game),
            "lock": SNEKCallable(lambda *args: game.get_level().lock(*args), Arity(0, 1)),
            "unlock": SNEKCallable(lambda *args: game.get_level().unlock(*args), Arity(0, 1)),
            "hide": SNEKCallable(lambda *args: game.get_level().hide(*args), Arity(0, 1)),
            "show": SNEKCallable(lambda *args: game.get_level().show(*args), Arity(0, 1)),
            "fade": Fade(game),
            ...
            "fill": SNEKCallable(lambda *args: game.get_level().fill(*args), Arity(0, 4)),
            ...
            "get_x": SNEKCallable(lambda *args: game.get_level().get_x(*args), Arity(0, 1)),
            "get_y": SNEKCallable(lambda *args: game.get_level().get_y(*args), Arity(0, 1)),
            "get_z": SNEKCallable(lambda *args: game.get_level().get_z(*args), Arity(0, 1)),
            "get_facing": SNEKCallable(lambda *args: game.get_level().get_facing(*args), Arity(0, 1)),
